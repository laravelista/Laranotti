        ...
        return (
            React.createElement("div", {className: "laracasts-lesson"}, 
                ...
                React.createElement("h4", null, 
                    ...
                    React.createElement("a", {onClick: this.watchLesson, target: "_blank", href: this.props.href}, this.props.heading)
                ), 
...
var Lessons = React.createClass({displayName: 'Lessons',
    render: function () {
        ...
        var lessonNodes = this.props.lessons.map(function (lesson, key) {
            return (
                React.createElement(Lesson, {item: lesson, watchLesson: that.props.watchLesson.bind(this, key), removeLesson: that.props.removeLesson.bind(this, key), watched: lesson.watched, toggleWatched: that.props.toggleWatched.bind(this, key), date: lesson.date, heading: lesson.title, text: lesson.summary, href: lesson.link})
            );
        });
        return (
                ...
                React.createElement("div", {className: "container-fluid"}, 
                    React.createElement("div", {className: "row"}, 
                        React.createElement("div", {className: "col-md-12"}, 
                            React.createElement(Lessons, {lessons: this.state.lessons, watchLesson: this.watchLesson, toggleWatched: this.toggleWatched, removeLesson: this.removeLesson})
                        )
                    )
                )
            )
